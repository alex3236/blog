...
最简单的办法是安装 #link("https://github.com/sebaxakerhtc/rdpwrap/releases")[RDP Wrap]，测试时使用 Windows 11 24H2 仍一切正常。

#figure(image("https://s2.loli.net/2025/04/25/kjO13XSv4osHWzu.png"))
...
#image("https://s2.loli.net/2025/04/25/n2MbkXylHF6VDrW.png")
...
然后，运行游戏，随便找个支持改坐标的自动点击器，比如 #link("https://tinytask.net/")[TinyTask]，就可以愉快地刷本了。
