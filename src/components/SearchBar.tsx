...
export default function SearchBar({ posts }: { posts: Post[] }) {
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-full md:col-span-4 md:col-start-2"
    >
      <div className="relative w-full rounded-xl border-2 border-gray-500 transition-all hover:shadow-xl dark:hover:bg-gray-800">
        ...
        <svg
          ...
          strokeWidth="0"
          viewBox="0 0 512 512"
          className="pointer-events-none absolute right-3 top-1/2 h-4 w-4 -translate-y-1/2 fill-gray-500 dark:text-gray-300"
          height="1em"
          width="1em"
