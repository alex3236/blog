  ...
  <picture className="flex flex-col items-center space-y-2">
    <PhotoView src={src}>
      <NextImage
        ...
        width={600}
        height={0}
        className={`h-auto max-h-[1000px] w-auto max-w-72 min-w-0 rounded-lg border-2 border-gray-600 sm:max-w-96 xl:max-w-xl dark:border-gray-300 dark:brightness-[.8] ${className}`}
        {...rest}
      />
    </PhotoView>
    {alt && alt.startsWith('#') && (
