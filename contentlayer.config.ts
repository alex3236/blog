...
import { allCoreContent, MDXBlog, sortPosts } from 'pliny/utils/contentlayer.js'
 ...
 */
async function createTagCount(allBlogs: MDXBlog[]) {
...
async function createCategoryCount(allBlogs: MDXBlog[]) {
